...
folder_path = r"G:\BIM\WIP\03_CIVIL3D\02_Библиотеки\01_Каталоги\02_Безнапорный\ASML_Каталог элементов\Metric Structures"

# Путь к файлу Excel, который нужно создать
excel_file = r"G:\BIM\WIP\03_CIVIL3D\02_Библиотеки\01_Каталоги\02_Безнапорный\ASML_Каталог элементов\Metric Structures.xlsx"
